...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // log文件的后缀名
    public static final String FILE_NAME_SUFFIX = "error.log";
...
//                public void run() {
//                    Looper.prepare();
//                    ToastUtil.showDevShortToast("المعذرة، حصل خطأ في البرنامج");
//                    Looper.loop();
//                }
//            }.start();
        } catch (Exception e) {
    ...
    private void saveToSDCard(Throwable ex) throws Exception {
        File file = FileUtils.getSaveFile("news_shanggame",
                FILE_NAME_SUFFIX);
