...
public class AttentionListAddAdapter extends BaseAdapter {
    ...
    public AttentionListAddAdapter(Context context){
        mContext=context;
    }
    ...
    protected View getMyView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder = ViewHolder.getViewHolder(mContext, convertView, parent, R.layout.item_attention_fragment_add, position);
        ...
        String exits = object.getString("exits");
        attentionState =  BooleanUtils.toBoolean(exits);
