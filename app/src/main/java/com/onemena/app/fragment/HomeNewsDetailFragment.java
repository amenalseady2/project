...
public class HomeNewsDetailFragment extends BaseFragment implements View.OnClickListener, BaseAdapter.OnViewClickListener, CommentFragment.StateChangeListener {
    ...
    private String is_follow_share;
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (Math.abs(upY - downY) < 100 && downX - upX < -200) {
                        ...
                        fragment.setOnStateChangeListener(HomeNewsDetailFragment.this);
    ...
    private LinearLayout lay_new_load;
    private ImageView new_not_data_img;
    private boolean is_local_art;

    //    private ImageView img_bottom_share_fb,img_bottom_share_tw,img_bottom_share_gl,img_bottom_share_sms,img_bottom_share_em;

    public static HomeNewsDetailFragment getInstance() {
        return new HomeNewsDetailFragment();
    }

    public static HomeNewsDetailFragment newInstance(String id, String categoryId, String position, String newsType, String isFollow) {
        HomeNewsDetailFragment fragment = new HomeNewsDetailFragment();
        Bundle args = new Bundle();
        args.putString(ID, id);
        args.putString(CATEGORY_ID, categoryId);
        args.putString(POSITION, position);
        args.putString(NEWS_TYPE, newsType);
        args.putString(IS_FOLLOW, isFollow);
        fragment.setArguments(args);
        return fragment;
    }

    public static HomeNewsDetailFragment newInstance(String id, String categoryId, String position, String newsType, String isFollow, boolean is_local) {
        HomeNewsDetailFragment fragment = new HomeNewsDetailFragment();
        Bundle args = new Bundle();
        args.putString(ID, id);
        args.putString(CATEGORY_ID, categoryId);
        ...
        args.putString(NEWS_TYPE, newsType);
        args.putString(IS_FOLLOW, isFollow);
        args.putBoolean(IS_LOCAL, is_local);
        fragment.setArguments(args);
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            is_follow_share = getArguments().getString(IS_FOLLOW);
            if ("0".equals(categoryId)) {
                commend = "1";
            } else {
                commend = "0";
            }
            is_local_art = getArguments().getBoolean(IS_LOCAL, false);
    ...
    protected void initData(View view, Bundle savedInstanceState) {
        ...
        lay_new_load = (LinearLayout) view.findViewById(R.id.lay_new_load);
        ...
        lay_error.setOnClickListener(this);
...
//        img_detail_time = (ImageView)web_view_head.findViewById(R.id.img_detail_time);
        ...
        checkMode();
//        img_new_load.setVisibility(View.VISIBLE);
        lay_new_load.setVisibility(View.VISIBLE);
        getDataFromNet(mId);
...
//                img_new_load.setVisibility(View.GONE);
            lay_new_load.setVisibility(View.GONE);
            ...
            if (StringUtils.isNotEmpty(is_follow_share) && "true".equals(is_follow_share)) {
                if (0 == is_follow) {
                    is_follow = 1;
...
//                    ToastUtil.showNormalShortToast("数据错误！");
            ...
            case R.id.look_origin://查看原文
                ...
                oaFragment.setOnStateChangeListener(HomeNewsDetailFragment.this);
            ...
            case R.id.img_bottom_share_fb:
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "Facebook"));
                isShared = true;
            ...
            case R.id.img_bottom_share_tw:
                ...
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "Twitter"));
                isShared = true;
            ...
            case R.id.img_bottom_share_gl:
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "Google"));
                isShared = true;
            ...
            case R.id.img_bottom_share_sms:
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "SMS"));
                isShared = true;
            ...
            case R.id.img_bottom_share_wa:
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "WhatApp"));
                isShared = true;
            ...
            case R.id.img_bottom_share_em:
                TongJiUtil.getInstance().putEntries(TJKey.SHARE,
                        ...
                        MyEntry.getIns(TJKey.RESOURCE_ID, mId),
                        MyEntry.getIns(TJKey.CATEGORY_ID, realCategoryId),
                        MyEntry.getIns(TJKey.SHARE_WAY, "Email"));
                isShared = true;
                String shareDesc = "\r\n" + title + "\r\n" + share_url + "\r\n";
    ...
    public void onViewClick(View view, int position) {
        ...
        HomeNewsDetailFragment instance = HomeNewsDetailFragment.getInstance();
    ...
    public void onDismiss(int commentNum) {
        ...
        indicator_count.setText(StringUtils.int2IndiaNum(String.valueOf(commentNum)));//评论个数-----
...
//                        commend = contentBean.getFeatured();//categoriescategories
                        if (is_local_art) {
                            realCategoryId = AppConfig.FINE_NEWS_CATEGORY_ID;
                        } else {
                            realCategoryId = contentBean.getCategories();//categories
                        }

                        share_url = contentBean.getShareUrl();
//                share_url = "http://6.dev.wekoora.com/share/"+mId;
...
//            img_detail_time.setImageResource(R.mipmap.details_comment_time_night);
            ...
            cover_view.setBackgroundColor(getResources().getColor(R.color.nightbg_252525));
            ...
            lay_error.setBackgroundColor(getResources().getColor(R.color.nightbg_1b1b1b));
            tv_dislike.setTextColor(getResources().getColor(R.color.nighttxt_707070));
            tv_like.setTextColor(getResources().getColor(R.color.nighttxt_707070));
            ...
            lay_new_load.setBackgroundColor(getResources().getColor(R.color.nightbg_252525));
...
//            img_detail_time.setImageResource(R.mipmap.details_comment_time);
            lay_new_load.setBackgroundColor(getResources().getColor(R.color.textcolor_F6F5F4));
            ...
            cover_view.setBackgroundColor(getResources().getColor(R.color.textcolor_F6F5F4));
            ...
            lay_error.setBackgroundColor(getResources().getColor(R.color.white));
