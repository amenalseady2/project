...
//                setCurrentItem(0, isBorderAnimation);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (stopScrollWhenTouch) {
            if ((ev.getAction() == MotionEvent.ACTION_DOWN && isAutoScroll)|| (ev.getAction() == MotionEvent.ACTION_MOVE && isAutoScroll)) {
                isStopByTouch = true;
                stopAutoScroll();
                    ...
                    if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT) {
                        ...
                        if (pageCount > 1) {
                            if (currentItem == 0 && downX <= touchX) {
                                setCurrentItem(pageCount - 1, isBorderAnimation);
                            }
                            if (currentItem == pageCount - 1 && downX >= touchX) {
                                setCurrentItem(0, isBorderAnimation);
                            }
                        }
