package com.onemena.widght.waveview;
...
class Wave extends View {
    private final int WAVE_HEIGHT_LARGE = (int) (8* Config.density);
    private final int WAVE_HEIGHT_MIDDLE = (int) (4* Config.density);
    private final int WAVE_HEIGHT_LITTLE = (int) (2* Config.density);
