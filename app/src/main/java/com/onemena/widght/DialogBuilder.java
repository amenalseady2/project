...
public class DialogBuilder extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setMutilBtn(String positiveButtonText, String cancelButtonText, ClickCallbak clickCallbak){
        ...
        public DialogBuilder create() {
            ...
            View layout = LayoutInflater.from(context).inflate(R.layout.view_common_dialog_layout, null);
