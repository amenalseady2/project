...
#实体类
#-----------------------------------------------------------------------------
-keep class com.onemena.home.model.javabean.** {*;}
-keep class com.onemena.search.model.javabean.** {*;}
-keep class com.onemena.data.eventbus.** {*;}
...
-dontwarn shanggame.news.greendao.**
 #保留一个完整的包
-keep class shanggame.news.greendao.** {*;}
-keep class com.asha.nightowllib.** {*;}