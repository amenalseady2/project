...

{
	...
	public String clip()
	{
		...
		draw(canvas);
		Bitmap bit = Bitmap.createBitmap(bitmap, mHorizontalPadding,
		...
		return FileUtils.getInstance().write2SDFromInput(name , datas).getAbsolutePath();
